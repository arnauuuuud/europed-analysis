...
colors = ['blue', 'green', 'red', 'cyan', 'magenta', 'yellow', 'orange', 'purple', 'brown', 'pink', 'gray', 'olive', 'lime', 'teal']
...
def main():
    ...
    eurobox_1 = TextBox(ax_textbox_1, '', initial='f4_eta0_ds0')
    ...
    eurobox_2 = TextBox(ax_textbox_2, '', initial='')
    ...
    eurobox_3 = TextBox(ax_textbox_3, '', initial='')
    ...
    # ax_x_parameter.set_aspect('equal')
    ...
    # ax_checkbox_envelope.set_aspect('equal')
    ...
    def change_plotlines(label):
        print(label)
        if label == 'Plot H-line':
            hline[0] = not hline[0]
        elif label == 'Plot V-line':
            vline[0] = not vline[0]
    checkbox_plotlines.on_clicked(change_plotlines)
    # ax_checkbox_envelope.set_aspect('equal')
    ...
    # ax_radiobutton_crit.set_aspect('equal')
    ...
    checkboxes_mode1.on_clicked(add_element_mode)
    ...
    checkboxes_mode2.on_clicked(add_element_mode)
    ...
    checkboxes_mode3.on_clicked(add_element_mode)
    ...
    checkboxes_mode4.on_clicked(add_element_mode)


    # ax_checkbox_mode.set_aspect('equal')
