...
def main():
    ...
    for europed_name in europed_names:
        ...
        te,ne = pedestal_values.create_profiles(europed_name,psis,profile=13)
        ax1.plot(psis,te,linewidth=3, label=europed_name)
        ax2.plot(psis, ne,linewidth=3)
        ax3.plot(psis,1.6*ne*te,linewidth=3)

        te,ne = pedestal_values.create_profiles(europed_name,psis,profile=17)
        ax1.plot(psis,te,linewidth=3, label=europed_name)
        ax2.plot(psis, ne,linewidth=3)
        ax3.plot(psis,1.6*ne*te,linewidth=3)
