...
def main():
    ...
    # POSITION NE
    # ax.vlines(ppos_ne, ymin=1.2, ymax=5, linestyle=':',linewidth=2.5, color=ne_color,zorder=10)
    ax.text(ppos_ne+0.005, ylim_ne[1], r'$p^{\mathrm{pos}}$', transform=ax.transData, ha='center',va='bottom', fontsize=fontsizetick, color='w')
    ...
    plt.savefig(f'../../../bouloulou/global4a.png')
    plt.close()
