...
europed_name = 'global_v4_87342_eta0_betan2.12_neped2.72_nesepneped0.57'
...
europed_name = 'global_v4_87342_eta1_betan2.12_neped2.72_nesepneped0.57'
te,ne = pedestal_values.create_profiles(europed_name,psis,crit=crit,crit_value=crit_value, fixed_width=fixed_width, exclud_mode = exclud_mode)
pe = 1.6*ne*te
...
axs[2].plot(psis, pe, color=color_europed_n50, linestyle=linestyle_n50)
...
te_p,ne_p = pedestal_values.create_profiles(europed_name,psis,crit=crit,crit_value=crit_value*(1+frac_uncertainty), fixed_width=fixed_width, exclud_mode = exclud_mode)
pe_p = 1.6*ne_p*te_p
axs[2].fill_between(psis, pe_m, pe_p, color=color_europed_n50, alpha=0.2)
...
axs[2].plot(psis, pe, color=color_europed_n20, linestyle=linestyle_n50)
...
te_p,ne_p = pedestal_values.create_profiles(europed_name,psis,crit=crit,crit_value=crit_value*(1+frac_uncertainty), fixed_width=fixed_width, exclud_mode = exclud_mode)
pe_p = 1.6*ne_p*te_p
axs[2].fill_between(psis, pe_m, pe_p, color=color_europed_n20, alpha=0.2)
